...
<head>
    ...
    <title>@yield('title', 'Toko Buku | Tentang Kami')</title>
...
<body class="bg-gray-100 font-sans antialiased flex flex-col min-h-screen">
    ...
    <!-- Container -->
    <div class="container mx-auto px-6 py-16 flex-1">
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg">
            <p class="text-lg text-gray-700 mb-4">
                ...
                Kami percaya bahwa membaca adalah jendela dunia, dan melalui <span
                    class="font-semibold text-blue-600">Toko Buku</span>,
            ...
            <p class="text-lg text-gray-700 mb-4">
                ...
                yang terus diperbarui, kami berharap dapat terus melayani Anda dengan cara yang terbaik.
            </p>
